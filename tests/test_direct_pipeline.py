...
def test_run_direct_pipeline_writes_house_quality_artifact(tmp_path, monkeypatch):
    ...
    assert result.artifact_paths["overlap_opportunity_report"].endswith("overlap_opportunity_report.json")
    assert result.artifact_paths["overlap_opportunity_markdown"].endswith("overlap_opportunity_report.md")
    ...
    assert (artifacts / "overlap_opportunity_report.json").exists()
    assert (artifacts / "overlap_opportunity_report.md").exists()
